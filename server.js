...
app.use((req, res, next) => {
  res.setHeader(
    ...
    "default-src 'self'; connect-src 'self' https://ifomorita.onrender.com; style-src 'self' https://fonts.googleapis.com https://cdnjs.cloudflare.com; font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com; script-src 'self' https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://translate.googleapis.com"
  );
  next();
});
